...
export class DatabaseService {
  ...
  async createTables() {
    await this.databaseObj.executeSql(
        `CREATE TABLE IF NOT EXISTS ${this.tables.categories} (id INTEGER NOT NULL, name TEXT, firstname TEXT, PRIMARY KEY(id AUTOINCREMENT))`,
        []
    );
  ...
  getFakeData() {
    this.httpClient.get(
      ...
      this.sqlPorter.importSqlToDb(this.databaseObj, data)
          .then(_ => {
            this.getCategories();
          })
